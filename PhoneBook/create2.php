...
if ($res1->num_rows == 1){
    ...
    echo "<h1 align='center'>Account Already Exists!<br>Try Another Username</h1>";
echo "<style> .table3{width:25%;margin-left:40%;font-size:x-large;}</style>";
echo "<br><table class='table3' align='center'><tr><td><a href='create.php' class='link'>Back</a></td>";
echo "<td><td><a href='index.php' class='link'>Login Screen</a></td></tr></table>";
