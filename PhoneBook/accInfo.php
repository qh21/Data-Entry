...
echo "<title>Account Info</title>";
 ...
 echo "<style>body{background-color:#395a79;color:#001a33;font-size:xx-large;text-align:center} fieldset{width:50%;margin-left:25%}";
    echo ".table1,.table2{border-color:#F00;} .table1{width:35%;font-size:x-large;margin-left:0%;text-align:left} .table2{width:35%;margin-left:25%}";
...
echo "<fieldset><legend>Personal Information</legend><table class='table1' align='center'><tr><th>Personal Name:</th><td>".$row['uName']."</td></tr>";
echo "<tr><th><br>Username:</th><td><br>".$row['Username']."</td></tr></table></fieldset>";

echo "<br><table class='table2' align='center'><tr>";
echo "<td><br><form method='post' id='homepageform' action='main.php'><input name='userName' value='".$userName."' hidden>";
echo "<input name='pwd' value='".$password."' hidden><a class='link' onclick='submitFunction()'>Home Page</a></td><td><a href='editInfo.php' class='link'>Edit Account Info</a></td></form>";
echo "<td><br><form id='deleteAccountForm'action='deleteAcc.php'><a class='link' onclick='submitFunction2()'>Delete Account</a></td></tr></table>";
